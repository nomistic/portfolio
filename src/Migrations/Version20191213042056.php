 ...
 */
final class Version20191213042056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stage CHANGE date_due date_due DATETIME DEFAULT NULL, CHANGE budget_hours budget_hours NUMERIC(10, 2) DEFAULT NULL, CHANGE budget_setrate budget_setrate INT DEFAULT NULL, CHANGE completed_hours completed_hours NUMERIC(10, 2) DEFAULT NULL, CHANGE notes notes LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stage CHANGE date_due date_due DATETIME DEFAULT \'NULL\', CHANGE budget_hours budget_hours NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE budget_setrate budget_setrate INT DEFAULT NULL, CHANGE completed_hours completed_hours NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE notes notes VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
