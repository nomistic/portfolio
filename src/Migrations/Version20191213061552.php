 ...
 */
final class Version20191213061552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stage ADD completed TINYINT(1) NOT NULL, CHANGE date_due date_due DATETIME DEFAULT NULL, CHANGE budget_hours budget_hours NUMERIC(10, 2) DEFAULT NULL, CHANGE budget_setrate budget_setrate INT DEFAULT NULL, CHANGE completed_hours completed_hours NUMERIC(10, 2) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stage DROP completed, CHANGE date_due date_due DATETIME DEFAULT \'NULL\', CHANGE budget_hours budget_hours NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE budget_setrate budget_setrate INT DEFAULT NULL, CHANGE completed_hours completed_hours NUMERIC(10, 2) DEFAULT \'NULL\'');
